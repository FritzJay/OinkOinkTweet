...
// and client options
// note: all config is optional and the process.env variables
...
var config = {
  ...
  idleTimeoutMillis: process.env.idleTimeoutMillis // how long a client is allowed to remain idle before being closed
}
